...
from app.generate.model.apply import submit_vertex_ai_request
from app.services.prompt.apply import create_quiz_prompt

router = APIRouter(prefix="/core", tags=["apply"])
